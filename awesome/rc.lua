...
globalkeys = mytable.join(
    ...
    -- Show help
    awful.key({ modkey,           }, "à",      hotkeys_popup.show_help,
    ...
    awful.key({ modkey, altkey    }, "r",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey, altkey    }, "c",     function () awful.tag.incmwfact(-0.05)          end,
    ...
    -- Rofi
    awful.key({ modkey            }, "h", function () os.execute("rofi -show run -terminal termite") end,
              {description = "Rofi run"   , group = "launcher"}),
    awful.key({ modkey            }, "g", function () os.execute("rofi -show window") end,
              {description = "Rofi window", group = "launcher"}),
    awful.key({ modkey            }, "p", function () os.execute("rofi -show drun -terminal termite") end,
              {description = "Rofi drun"   , group = "launcher"}),
    awful.key({ modkey            }, "v", function () os.execute("rofi -modi 'clipboard:greenclip print' -show clipboard -run-command '{cmd}'") end,
...
clientkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift"   }, "y",      function (c) c:kill()                         end,
