...
base000 = "#21252D" # light-background
focus = "#FFFF00" # focus

base00 = "#18191E" # background
base01 = "#FC2929" # red
base02 = "#44B273" # green
base03 = "#E25600" # orange
base04 = "#1D918B" # blue
base05 = "#D16BB7" # magenta
base06 = "#00BFA4" # cyan
base07 = "#CCCCCC" # grey
base08 = "#FFEE79" # foreground
base09 = "#FF5050" # light-red
base0A = "#50C16E" # light-green
base0B = "#ED722E" # light-orange
base0C = "#47A8A1" # light-blue
base0D = "#D68EB2" # light-magenta
base0E = "#5AD1AA" # light-cyan
base0F = "#FFFADE" # white
...
c.colors.completion.odd.bg = base000
...
c.colors.completion.category.bg = base06
...
c.colors.contextmenu.menu.fg =  base08

# Background color of the context menu’s selected item. If set to null, the Qt default is used.
c.colors.contextmenu.selected.bg = focus
...
c.colors.messages.info.fg = base08
...
c.colors.prompts.fg = base08

# Border used around UI elements in prompts.
c.colors.prompts.border = base07

# Background color for prompts.
c.colors.prompts.bg = base00

# Background color for the selected item in filename prompts.
c.colors.prompts.selected.bg = base000
...
c.colors.statusbar.command.bg = base000

# Foreground color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.fg = base00

# Background color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.bg = base07

# Foreground color of the statusbar in caret mode.
c.colors.statusbar.caret.fg = base00

# Background color of the statusbar in caret mode.
c.colors.statusbar.caret.bg = base04

# Foreground color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.fg = base00

# Background color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.bg = base0B

# Background color of the progress bar.
c.colors.statusbar.progress.bg = base08
...
# Foreground color of the URL in the statusbar on successful load
# (https).
c.colors.statusbar.url.success.https.fg = base08
...
c.colors.tabs.pinned.odd.bg = base000
