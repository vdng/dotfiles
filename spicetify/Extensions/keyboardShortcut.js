...
(function KeyboardShortcut() {
    ...
    // T and S to switch sidebar items
    registerBind("T", false, true, false, rotateSidebarDown);
    registerBind("S", false, true, false, rotateSidebarUp);

    // q to open Queue page
    registerBind("Q", false, false, false, clickQueueButton);

    // C and R to go back and forward page
    registerBind("C", false, true, false, clickNavigatingBackButton);
    registerBind("R", false, true, false, clickNavigatingForwardButton);

    // Alt + t, Alt + s to focus on iframe app before scrolling
    registerBind("T", false, false, true, focusOnApp);
    registerBind("S", false, false, true, focusOnApp);

    // j and k to vertically scroll app
    registerBind("T", false, false, false, appScrollDown);
    registerBind("S", false, false, false, appScrollUp);

    // c and r to horizontally scroll carousel
    registerBind("C", false, false, false, carouselScrollLeft);
    registerBind("R", false, false, false, carouselScrollRight);
...
function VimBind() {
    ...
    const keyList = "auieovtsnr".split("");
    ...
    function createKey(key, isATag) {
        ...
        div.innerText = key;
        div.style.backgroundColor = "#18191e";
        div.style.border = "solid 1px #ffee79";
        div.style.color = "#ffee79";
