...
class Keys:
    ...
    previous_tab = ["Alt+Shift+Left", "Alt+Shift+C"]
    next_tab     = ["Alt+Shift+Right", "Alt+Shift+R"]
    ...
    notifications_highlights_only = ["Ctrl+Alt+X"]
    ...
    class Scrolling:
        ...
        up        = ["Alt+Up", "Alt+S"]
        down      = ["Alt+Down", "Alt+T"]
        page_up   = ["Alt+Ctrl+Up", "Alt+Ctrl+S", "PgUp"]
        page_down = ["Alt+Ctrl+Down", "Alt+Ctrl+T", "PgDown"]
        top       = ["Alt+Ctrl+Shift+Up", "Alt+Ctrl+Shift+S", "Home"]
        bottom    = ["Alt+Ctrl+Shift+Down", "Alt+Ctrl+Shift+T", "End"]
    ...
    class Rooms:
        ...
        previous = ["Alt+Shift+Up", "Alt+Shift+S"]
        next     = ["Alt+Shift+Down", "Alt+Shift+T"]
    ...
    class Chat:
        ...
        send_clipboard_path = ["Alt+Shift+J"]
    ...
    class Messages:
        ...
        previous = ["Ctrl+Up", "Ctrl+S"]
        next     = ["Ctrl+Down", "Ctrl+T"]
    ...
    class ImageViewer:
        ...
        pan_left  = ["C", "Left", "Alt+H", "Alt+Left"]
        pan_down  = ["T", "Down", "Alt+J", "Alt+Down"]
        pan_up    = ["S", "Up", "Alt+K", "Alt+Up"]
        pan_right = ["R", "Right", "Alt+L", "Alt+Right"]
